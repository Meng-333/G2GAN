import torch
import os, argparse
from model.infraffn import InfraFFN     # 本文提出的方法
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='InfraFFN',
...
def main():
    ...
    # test
    # 测试集下不同数据集逐个测试
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/InfraFFN/model/generator_param.pkl")
