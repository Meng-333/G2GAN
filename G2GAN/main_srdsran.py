import torch
import os, argparse
from model.srdsran import SRDSRAN     # 本文提出的方法
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='SRDSRAN',
    ...
    parser.add_argument('--train_dataset', type=list, default=["Train"], choices=["DroneVehicle", "M3IR", "FLIR", "AVSM"],
...
def main():
    ...
    # 测试集下不同数据集逐个测试
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/SRDSRAN/model/generator_param.pkl")
