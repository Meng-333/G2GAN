import torch
import os, argparse
from model.dasrgan import DASRGAN     # 本文提出的方法
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='DASRGAN',
    ...
    parser.add_argument('--weight_content', type=float, default=0.1, help='Loss weight for content loss　')
...
def main():
    ...
    # test
    # 测试集下不同数据集逐个测试
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/DASRGAN/model/generator_param.pkl")
